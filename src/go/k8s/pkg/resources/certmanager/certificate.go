...
func NewCertificate(
	...
	return &CertificateResource{
		client, scheme, pandaCluster, key, issuerRef, fqdn, logger.WithValues("Kind", certificateKind()),
	}
}
...
func (r *CertificateResource) Obj() (k8sclient.Object, error) {
	...
	cert := &cmapiv1.Certificate{
		...
		Spec: cmapiv1.CertificateSpec{
			DNSNames: []string{
				"*." + strings.TrimSuffix(r.fqdn, "."), // TODO argument for common name.
			},
			SecretName: r.Key().Name,
			IssuerRef:  *r.issuerRef, // TODO ensure both objects not nil
			IsCA:       true,         // TODO variable
		},
	}
